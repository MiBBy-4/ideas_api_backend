...
ActiveRecord::Schema.define(version: 2022_03_12_194733) do
  ...
  create_table "responses", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["customer_id", "idea_id"], name: "index_responses_on_customer_id_and_idea_id", unique: true
    t.index ["customer_id"], name: "index_responses_on_customer_id"
  ...
  add_foreign_key "responses", "customers"
